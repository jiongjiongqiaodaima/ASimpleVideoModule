...
- (void)initialize
{
    ...
    self.thumbImageView.center = CGPointMake(self.bounds.size.width/2, self.bounds.size.height/2 - 12);
    ...
    _themeNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, 13)];
    self.themeNameLabel.center = CGPointMake(self.bounds.size.width/2, self.thumbImageView.frame.size.height + 6);
    ...
    self.themeNameLabel.textColor = ZLColorFromRGB(0xffffff);
    ...
    self.selectedBackgroundView.center = CGPointMake(self.bounds.size.width/2, self.bounds.size.height/2 - 12);
