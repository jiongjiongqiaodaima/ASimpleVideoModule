...
- (CAShapeLayer*) buildEmitterSparkle:(CGSize)viewBounds text:(NSString*)text startTime:(NSTimeInterval)timeInterval
{
    ...
    CGPoint position = CGPointMake(viewBounds.width/2, viewBounds.height * 3/4);
...
- (CALayer *)buildAnimationStarText:(CGSize)viewBounds text:(NSString*)text startTime:(NSTimeInterval)startTime
{
    ...
    // 3.
    CABasicAnimation *fadeInAnimation = [CABasicAnimation animationWithKeyPath:@"opacity"];
    fadeInAnimation.fromValue = @1.0f;
    fadeInAnimation.toValue = @1.0f;
    fadeInAnimation.additive = NO;
    fadeInAnimation.removedOnCompletion = NO;
...
- (void)addCommentaryTrackToComposition:(AVMutableComposition *)composition withAudioMix:(AVMutableAudioMix *)audioMix
{
    ...
    [trackMixComentray setVolumeRampFromStartVolume:0.0f toEndVolume:1.0f timeRange:startRange];
